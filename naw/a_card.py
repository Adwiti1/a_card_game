...
# Compliments list
compliments = [
    "dang you're doing so well keep going",
    ...
    "You're the flippin' cutest penguin in the whole colony!",
    "I'd waddle a thousand miles just to be by your side.",
    "You make my heart feel warmer than a nest full of pebbles!",
    "If love was an iceberg, ours would never melt.",
    "You're my perfect pebble, and I’d pick you every time.",
    "Every time I see you, my flippers get all fluttery!",
    "You’re the only penguin I ever want to huddle with.",
    "With you, every day feels like sliding on fresh snow.",
    "You're more dazzling than a sunrise on the Antarctic ice.",
    "No matter how cold the world gets, I’ll always keep you warm."
]
...
while running:
    ...
    if generate_hearts_rn: 
        ...
        if generate_heart_odds == 0:
            ...
            love_bomb_1.create()
            if period_mode:
                love_bomb_1.set_health(3)
                love_bomb_1.set_speed(11)
